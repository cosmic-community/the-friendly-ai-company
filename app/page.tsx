...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-sunshine-100 rounded-3xl p-8 sm:p-12 text-center">
              <img
                src="https://imgix.cosmicjs.com/d6f6ba40-2e93-11f1-86e7-4be326c2a87b-generated-1775134792625.jpg?w=600&h=400&fit=crop&auto=format,compress"
      ...
      {/* CTA */}
      <section className="py-16 sm:py-20 bg-sunshine-400">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/shop"
              className="inline-flex items-center justify-center px-8 py-4 bg-gray-900 text-white font-semibold rounded-2xl hover:bg-gray-800 transition-all duration-300 text-lg shadow-lg"
            >
              Shop Now
            </Link>
            <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 bg-white/40 backdrop-blur-sm text-gray-900 font-semibold rounded-2xl hover:bg-white/60 transition-all duration-300 text-lg">
              Get in Touch
            </Link>
          </div>
        </div>
